...
export default function Home() {
  return <main id="main-content"><Header/>
    ...
    <section className="possibilities"><div><p className="eyebrow">Potential applications</p><h2>From a 10–15 minute test.</h2></div><p className="applicationsCopy">Platform concepts include quantitative insulin detection, viral detection, and respiratory disease panels. Each application requires its own assay development and validation.</p></section>

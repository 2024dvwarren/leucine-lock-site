...
export default function Privacy() {
  return (
    <main className="legal-page" id="main-content">
      ...
      <h1>Privacy</h1>
      <p>
        This informational website does not use advertising cookies or third-party
        analytics. If you contact us through the website form, by email, or by
        telephone, we use the information you provide only to respond to your
      ...
      <p>
        ...
        records. Website form submissions are transmitted through FormSubmit for
        delivery to our email inbox. We do not sell personal information.
      </p>
      <h2>Questions</h2>
      <p>
